...
- **Aesthetic:** "The Drafting Table" — ink on warm paper, editorial serif display type
  (Fraunces), one oxblood "red pen" accent, and self-drawing SVG paths (underlines,
  circled annotations, a continuous process stroke) as the brand motif.
